...
class FetchBeneficiaryStrongAuthentication extends RequestModel implements RequestInterface
{
    /**
     * @var integer
     */
    ...
    {
        return sprintf('/beneficiaries/%s/strongAuthentications', $this->id);
    }
